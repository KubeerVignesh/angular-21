  ...
  template: `
    <div class="container mx-auto px-4 py-4 max-w-5xl">
      @if (user(); as currentUser) {
        ...
        <dialog
          #editDialog
          class="m-auto rounded-2xl shadow-2xl p-0 bg-transparent text-left sm:max-w-4xl sm:w-full border-none focus:outline-none"
        >
          <div
            class="bg-white dark:bg-slate-800 rounded-2xl py-4 shadow-2xl overflow-hidden flex flex-col max-h-[90vh]"
          >
...
export class Profile {
  ...
  openEditModal() {
    ...
    this.profileModel.set({
      ...
      pinCode: u.pinCode || '',
      dob: u.dob || '',
      dobDate: u.dob ? new Date(u.dob) : null,
      image: u.image || '',
    });
